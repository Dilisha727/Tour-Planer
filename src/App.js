...
const AITravelPlanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let prompt = `Generate a personalized travel itinerary for a trip to ${sriLankaTrip.destinationCountry} with a budget of ${sriLankaTrip.budget}. The traveler is interested in a ${sriLankaTrip.travelStyle} vacation and enjoys ${sriLankaTrip.interestsNew}. They are looking for ${sriLankaTrip.accommodationType} accommodations and prefer ${sriLankaTrip.transportationType} transportation. The itinerary should include ${sriLankaTrip.activityType} activities and ${sriLankaTrip.cuisineType} dining options. Please provide a detailed itinerary with daily recommendations for ${sriLankaTrip.tripDuration} days, including suggested destinations, activities, and dining options. The itinerary should be written in ${sriLankaTrip.language}.`;

    let prompt2 = `Generate a list of hotels in ${sriLankaTrip.destinationCountry} available for a stay, each priced at or under ${sriLankaTrip.budget} per night. Provide the details in the following JSON array format:

[
  {
    "name": "Hotel Name",
    "price": "Price per night in LKR",
    "location": "Hotel's address in ${sriLankaTrip.destinationCountry}",
    "image": "Link to an image of the hotel",
    "source": "Booking.com",
    "link": "Direct link to the hotel’s page on Booking.com"
  },
  ...
]

Each object should include:
1. **name**: The hotel's name.
2. **price**: The nightly rate for the hotel room.
3. **location**: The address or area of the hotel within ${sriLankaTrip.destinationCountry}.
4. **image**: A link to an image of the hotel.
5. **source**: The booking platform, which should be "Booking.com".
6. **link**: A direct link to the hotel’s page on Booking.com.

Please provide approximately 5 hotels in this format, with realistic prices and accurate information for the specified location and price range.
`
